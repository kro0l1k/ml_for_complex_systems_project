...
class Solver(object):
    ...
    def train(self):
        ...
        print(' (this isnt true!!!! ) Y0_true: %.4e' % y_init)
    ...
    def train_step(self, train_data):
        ...
        del tape
        self.optimizer.apply_gradients(zip(grad, self.model.trainable_variables)) # NOT SURE|ig we are trainging to find Y0 too!!! no way we w
